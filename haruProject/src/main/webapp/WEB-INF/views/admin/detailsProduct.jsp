				        	...
				        	<div class="js-pro-info">
					        	...
					        	<table>
					        		...
					        		<tr>
					        			...
					        			<td>
					        				${product.pno }
					        				<input class="haru-pro-pno" name="pno" type="hidden">
					        			</td>
					        		</tr>
					        		<tr>
					        		...
					        		<tr>
					        			...
					        			<td>
					        				<input class="haru-pro-price" name="pprice" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(.*)\./g, '$1');"
									...
									<c:choose>
										...
										<c:otherwise>
											<div class="pro-label-div">
												...
												<input type="file" id="main_img" name="main_img" accept=".jpg, .jpeg, .png, .gif"> 							
											</div>
										</c:otherwise>
									</c:choose>
					        	</div>
